...
5. パスワードは「**パスワード生成...**」（**⌘G**）で作れます。生成ウィンドウの「**入力先**」で入れる欄を選び、「**この項目に入力**」を押すとそこへ直接入ります（クリップボードを経由しません）
...
セキュア情報ウィンドウ（「**パスワード生成...**」/ **⌘G**）や指紋パスワード管理画面からも、パスワード生成を呼び出せます。セキュア情報ウィンドウから開いた場合は「**入力先**」の選択と「**この項目に入力**」ボタンが増え、選んだフィールドへ生成値が直接入ります。
