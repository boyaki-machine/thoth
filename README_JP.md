...
5. パスワードは「**パスワード生成...**」（**⌘G**）で作れます。直前に編集していたフィールドがあれば、生成ウィンドウの「**この項目に入力**」でそこへ直接入ります（クリップボードを経由しません）
...
セキュア情報ウィンドウ（「**パスワード生成...**」/ **⌘G**）や指紋パスワード管理画面からも、パスワード生成を呼び出せます。セキュア情報ウィンドウから開いた場合は「**この項目に入力**」ボタンが増え、編集していたフィールドへ生成値が直接入ります。
